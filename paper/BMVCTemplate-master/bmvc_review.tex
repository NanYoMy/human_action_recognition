...
\begin{table*}[htbp]
	\begin{center}	
		...
		\end{tabular}	
	\end{center}
	\caption{ the classification accuracies of the method with different number of support samples on UTD-MHAD and KARD datasets. All accuracy result is averaged over 1000 test episodes. }	
	\label{tab:4}
\end{table*}
